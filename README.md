...
I'll update the cheat with new features, bugs fixes, etc..
...
`5. Inject your DLL and wait until the watermark appears in the top left corner of the screen. (you can check the in-game console for some status)`
